...
describe("Check message constructor", () => {
  ...
  it("should return buffer of addRoSpec command", async () => {
    ...
    const expectedResponse: Buffer = new Buffer(
      "0414000000500000000400b1004600000001000000b2001200b300050000b60009000000000000b700180001000000b80009000000000000ba0007007B0100ed001201000100ee000bffc0015c0005c0",
      "hex"
    );
  ...
  it("should return buffer of Antenna configuration parameter", async () => {
    ...
    const expectedResponse: Buffer = new Buffer(
      "00DE003C000100DF0006000100e0000a000100010057014a002600014f0008000300000150000b4000200000000003ff000e0000651a000000170001",
      "hex"
    );
